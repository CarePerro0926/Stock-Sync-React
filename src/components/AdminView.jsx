        ...
        <div className="p-4">
          ...
          {showMenu && (
            <div id="adminMenu" className="list-group mb-3 d-md-none" style={{ display: 'block' }}>
              ...
              <button className="list-group-item list-group-item-action" onClick={() => selectTab('add')}>Agregar</button>
              <button className="list-group-item list-group-item-action" onClick={() => selectTab('update')}>Actualizar</button>
          ...
          <div className="overflow-auto" style={{ minHeight: '60vh' }}>
